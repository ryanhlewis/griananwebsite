            ...
            if (p.test(h)) {
                ...
                e.ajax({
                    ...
                    error: function(e) {
                        ...
                        $(".message").html('<p class="notify-valid">Congrats! You are on the list.<br>We will inform you as soon as we finish.<br> With <3, The Mists of Grianan Team</p>').fadeIn();
                        }
                    }
                }).done(function(e) {
                    o.hide();
